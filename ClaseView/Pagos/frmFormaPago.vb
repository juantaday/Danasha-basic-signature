...
Public Class frmFormaPago
    ...
    Private MontoAutorizado As Decimal
    Private TotalDeuda As Decimal
        ...
        Try
            If Double.Parse(txtPaga.Text) >= Double.Parse(txtTotal.Text) Then
                ...
                With Pagos
                    ...
                    .fech_Pago = Now()
                End With
                Vuelto = RedondearSi(Double.Parse(txtPaga.Text) - Double.Parse(txtTotal.Text), 2)
    ...
    Private Function Mensaje_Credito() As Boolean
        Try
            ...
            Dim CurrentCredit As Decimal = 0
    ...
    Private Async Sub Saldo_Deudas()
        Try
            ...
            Select Case flag
                Case "Clientes"
                    ...
                    Me.MontoAutorizado = Await StoreProcedure.GetMontoMaximoCliente(Me.idcliente)
            ...
            If isResponse Then
                ...
                Me.TotalDeuda = RedondearSi(TotalDeudas - TotalPagado, 2)
                txtSaldo.Text = TotalDeuda.ToString("C2")
                ...
                txtTotalDeuda.Text = (Me.TotalDeuda + CurrentCredit).ToString("C2")
                Me.txtMontoMaximo.Text = MontoAutorizado.ToString("C2")
            End If
        Catch ex As Exception
            MsgBox(ex.Message & vbLf & ex.StackTrace, MsgBoxStyle.Critical, "Error")
        End Try
