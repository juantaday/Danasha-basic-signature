...
Public Class rptFacturaBacha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DanashaBasicSignature.rptFacturaBacha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaBacha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaBacha = New rptFacturaBacha()
        rpt.Site = Me.Site
        Return rpt
    End Function
