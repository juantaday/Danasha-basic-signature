...
Public Class rptRentabilidadXMes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRentabilidadXMes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRentabilidadXMes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRentabilidadXMes = New rptRentabilidadXMes()
        rpt.Site = Me.Site
        Return rpt
    End Function
