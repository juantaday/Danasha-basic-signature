...
Public Class SalesWithDiscountRpt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SalesWithDiscountRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MyEcommece() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSalesWithDiscountRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesWithDiscountRpt = New SalesWithDiscountRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
