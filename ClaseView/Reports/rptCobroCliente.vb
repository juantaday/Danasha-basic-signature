...
Public Class rptCobroCliente
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_num_cobro() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCobroCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCobroCliente = New rptCobroCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
