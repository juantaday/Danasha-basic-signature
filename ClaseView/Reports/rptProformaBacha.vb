...
Public Class rptProformaBacha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DanashaBasicSignature.rptProformaBacha.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idFactur() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptProformaBacha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProformaBacha = New rptProformaBacha()
        rpt.Site = Me.Site
        Return rpt
    End Function
