...
Public Class frmViewUtilidadxMes
    ...
    End Sub
    Private Sub frmViewUtilidadxMes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ViewReport()
    End Sub
    ...
    Private Async Sub ViewReport()
        ...
        Try
            ...
            Dim lsiPurchAndSale = Await StoreProcedure.GetUtilitiesxMes(LastDateSales.Year, LastDateSales.Month,
                                    fromDate.Year, fromDate.Month)

            Dim rpt As New ReportDocument
            rpt.Load(file_rptRentabilidadXMes)
