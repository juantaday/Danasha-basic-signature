...
Public Class frmAdd_Personas
    ...
    Private Function Operation_Person() As Boolean
        Try
            ...
            Select Case state
                Case stateOperation.Insert
                    If idPersona = 0 Then
                        idPersona = ClsPerson.InsertPerson(ApellidosText.Text, NombreText.Text,
                                                           Ruc_CiText.Text, DireccionText.Text,
                                                           TelefonoText.Text,
        ...
        Catch ex As Exception
            ...
            If ex.Message.Contains("UQ__Personas__82F42CE7D2784542") Then
                message = "El número de Ruc/C.I. ya esta registrado.."
            Else
    ...
    Private Sub Ruc_CiText_TextChanged(sender As Object, e As EventArgs) Handles Ruc_CiText.TextChanged
        lblCuntRuc.Text = Ruc_CiText.Text.Length.ToString()
    End Sub
