...
Public Class frmList_Person
    ...
    Private Sub PanelMas_Enter(sender As Object, e As EventArgs)
        Try
            ...
            PersonVisibleNemuClicLabel.Text = personLaber.Text
            PersonVisibleNemuClicLabel.Tag = personLaber.Tag
            DetailsButton.Enabled = True
            EditButton.Enabled = True
            DeleteButton.Enabled = True
            PersonClickNamaLabel.Text = PersonVisibleNemuClicLabel.Text & " (" & PersonVisibleNemuClicLabel.Tag & ")"
            idPersona = pictureImage.Tag
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles FindButton.Click
        Try
            ...
            Dim response = GeneratedSplit.GenerateSpliter(FindTextBox.Text.Trim())

            If (Not response.IsSucces Or response.IsCode) Then
                MsgBox("No se pudo analizar los daatos a consultar")
                Return
            End If
    ...
    Private Sub AddNewButton_Click(sender As Object, e As EventArgs) Handles AddNewButton.Click
        Try
            ...
            Using newAddPerson As New frmAdd_Personas(stateOperation.Insert, 0)
                With newAddPerson
                    .ShowDialog()
                    If .DialogResult = System.Windows.Forms.DialogResult.OK And Not (Me.stateLoad = stateLoad.Select) Then
                        FindTextBox.Text = .Ruc_CiText.Text
                        FindButton.PerformClick()
                        FindTextBox.Text = String.Empty
                    ElseIf (.DialogResult = System.Windows.Forms.DialogResult.OK And (Me.stateLoad = stateLoad.Select)) Then
