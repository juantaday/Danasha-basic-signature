...
Public Class frmConfFactura
    ...
    Private Sub Carga_NumDocument(idDocument As Integer, idTerminal As Integer)
        Try
            txtnumfactur1.Text = SettingObject.WareHouseActive.CodEstablec
            txtnumfactur2.Text = TerminalActivo.CodPntoEmision
            ...
            Using dat As New TerminalConfiTableAdapter
                Using dt As New TerminalConfiDataTable
                    ...
                    If dt.Rows.Count = 1 Then
                        idTerminalConfig = dt.Rows(0)("idTerminalConfi")
        ...
        Try
            Using dat As New TerminalConfiTableAdapter
                If dat.InsertNumDocument(txtnumfactur1.Text,
                                         ...
                                         txtnumfactur4.Text,
                                         Me.idTerminal,
                                         Me.DocumentListBox.SelectedValue) = 1 Then
                    Return True
                End If
            End Using
            Return False
