...
Module FfacturacionVenta
    ...
    Public Function Procesa_Venta() As Boolean
        Try
            ...
            ' @ID_FACT
            cmd.Parameters.Add("@IdFactur", SqlDbType.Int, 32)
            cmd.Parameters("@IdFactur").Direction = ParameterDirection.Output
            'Err_code @ID_FACT
            Err_code = 0
            sql = ""
            ...
            If cmd.ExecuteNonQuery() >= 0 Then
                ...
                FacturVenta.idFactur = cmd.Parameters("@IdFactur").Value
                If Err_code > 0 Then
                    Return False
                End If
                Return True
