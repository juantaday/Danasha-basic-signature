...
Public Class frmUsuarios
    ...
    Private Sub especialPerminButton_Click(sender As Object, e As EventArgs) Handles especialPerminButton.Click
        Try
            ...
            Dim codUser As String = String.Empty

            If Me.dataGridUser.SelectedRows.Count = 1 Then
                codUser = dataGridUser.SelectedCells.Item(0).Value
            End If

            If (String.IsNullOrEmpty(codUser)) Then Return


            Cursor = Cursors.WaitCursor
            Using specialUserPer As New frmPermososSpecial(codUser)
