...
Public Class frmAdminOfertas
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        If Me.ChkExpira.Checked Then
            If FormatDateTime(expireDate.Value, DateFormat.ShortDate) < FormatDateTime(Date.Now, DateFormat.ShortDate) Then
    ...
    Private Sub ChkExpira_CheckStateChanged(sender As Object, e As EventArgs) Handles ChkExpira.CheckStateChanged
        ' Me.expireDate.Enabled = ChkExpira.CheckState
    End Sub
    ...
    Private Sub ChkExpira_CheckedChanged(sender As Object, e As EventArgs) Handles ChkExpira.CheckedChanged
        expireDate.Enabled = ChkExpira.Checked
    End Sub
End Class
