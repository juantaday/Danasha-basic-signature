...
Partial Class frm_Proveedor
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Listado deproveedores de este presentació" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "Detalle de ultima compra."
        '
        'frm_Proveedor
        '
