        ...
        Try
            ...
            Using connection As New SqlConnection(SimpleDataApp.Utility.GetConnectionString())
                ...
                Try
                    ...
                    command.CommandText = "Update [CajaDetailDocument] Set isArching = 1 where idCajaStado = " & idCajaStatus & " "
                    response = command.ExecuteNonQuery()

                    command.CommandText = "Update [DBpanaderia].[dbo].[CajaDetailDocument] Set isArching = @isArching " _
