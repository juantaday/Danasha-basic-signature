...
Public Class FrmSaldo_caja
    ...
    Sub New(_idTerminal As Integer)
    ...
    Private Sub Carga_Datos()
        ...
        Try
            ...
            For Each row As DataRow In dtList.Rows
                ...
                Dim colSaldos As New System.Data.DataColumn With { _
                    .ColumnName = "Saldo", _
        ...
        Finally
            ...
            If PanelView.Controls.Count = 0 Then
                ...
                Dim LinkLabelNew As New Windows.Forms.LinkLabel With {
                    .AutoSize = False,
                    .Height = 18,
                    .Dock = DockStyle.Top,
    ...
    Private Sub Inicializa_Controls()
        Try
            ...
            Me.PanelData = New Windows.Forms.Panel With {
                           .Height = 180,
                           .Name = "PanelData",
                           .BorderStyle = BorderStyle.FixedSingle,
                           .Dock = DockStyle.Top
                           }
            Me.PanelTop = New Windows.Forms.Panel With {
                           .Name = "PanelTop",
                           .Height = 30,
                           .Dock = DockStyle.Top}
            Me.PanelLeft = New Windows.Forms.Panel With {
                           .Name = "PanelLeft",
                           .Width = 35,
                           .Dock = DockStyle.Left}
            Me.itemCheckBox = New Windows.Forms.CheckBox With {
                           .Name = "itemCheckBox",
                           .Width = 20,
                           .ForeColor = Color.Transparent,
                           .Dock = DockStyle.Left
                           }
            Me.ButtonTitle = New Windows.Forms.Button With {
                           .AutoSize = True,
                           .Height = 30,
                           .Name = "ButtonTitle",
                           ...
                           .Font = font,
                           .Cursor = Cursors.Hand}
            Me.PanelList = New Windows.Forms.Panel With {
                           .Name = "PanelList",
                           .Dock = DockStyle.Fill}
            Me.DtgView = New Windows.Forms.DataGridView With {
                           .Name = "DtgView",
                           .Dock = DockStyle.Fill}
            Me.LabelTotal_op = New Windows.Forms.Label With {
                           .Name = "LabelTotal_op",
                           .AutoSize = False,
                           .Height = 20,
    ...
    Private Sub ButtonTitle_Click_Format(sender As Object, e As EventArgs)
        Try
            ...
            Dim _panel As Windows.Forms.Panel = sender.Parent
            _panel.Tag = 1
    ...
    Private Sub EliminarToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EliminarToolStripMenuItem.Click
        Try
            If (MsgBox("Está seguro de eliminar." & vbNewLine & msgSelect, _
    ...
    Private Sub ArqueoDeCajaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ArqueoDeCajaToolStripMenuItem.Click
        ...
        End Try
    End Sub
    Friend WithEvents PanelData As Windows.Forms.Panel
    Friend WithEvents PanelTop As Windows.Forms.Panel
    Friend WithEvents PanelLeft As Windows.Forms.Panel
    Friend WithEvents PanelList As Windows.Forms.Panel
    Friend WithEvents ButtonTitle As Windows.Forms.Button
    Friend WithEvents DtgView As Windows.Forms.DataGridView
    Friend WithEvents LinkLabelNew As Windows.Forms.LinkLabel
    Friend WithEvents LabelTotal_op As Windows.Forms.Label
    Friend WithEvents itemCheckBox As Windows.Forms.CheckBox
