...
Public Class MoneyDetail
    ...
    Public Sub New(RealizedMenu As ToolStripMenuItem,
                   ...
                   TotalLabel As Windows.Forms.Label,
                   idMoney As Integer)
    ...
    Private Sub QuantityEntry_GotFocus(sender As Object, e As Windows.RoutedEventArgs)
        sender.SelectAll()
    End Sub

    Private Sub QuantityEntry_GotMouseCapture(sender As Object, e As Windows.Input.MouseEventArgs)
        sender.SelectAll()
    End Sub
    ...
    Private Sub QuantityEntry_TextChanged_Villete(sender As Object, e As TextChangedEventArgs)
        ...
        End Try
    End Sub
    Private Sub CheckBoxIsChecken_Checked(sender As Object, e As Windows.RoutedEventArgs)
