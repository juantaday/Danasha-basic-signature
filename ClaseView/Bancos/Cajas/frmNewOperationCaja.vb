...
Public Class frmNewOperationCaja
    ...
    Private Function insertCajas(cn As SqlConnection, idCajaStado As Integer, transaction As SqlTransaction) As Boolean
        Try
            ...
            cmd.CommandType = CommandType.Text
            sql = "insert into Cajas(idCajaStado,codUserMovi,Descripcion,idFormaPago,debe,onControl,TypoMovi) "
            sql = sql & "Values(@idCajaStado,@codUserMovi,@Descripcion,@idFormaPago,@haber,@onControl,@TypoMovi)"
            ...
            cmd.Parameters.Add("@haber", SqlDbType.Decimal)
            cmd.Parameters("@haber").Value = montoInicial
    ...
    Private Sub ImputInicio_Button_Click(sender As Object, e As EventArgs) Handles ImputInicio_Button.Click
        Try
            Using newsdata As New frmMonedasAdmin
                With newsdata
                    .StartPosition = FormStartPosition.CenterScreen
                    .ShowDialog()
                    If .DialogResult = Windows.Forms.DialogResult.OK Then
