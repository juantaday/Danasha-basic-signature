    ...
    Private Sub FindClienteButton_Click(sender As Object, e As EventArgs) Handles FindClienteButton.Click
        Using listclient As New frmList_clientes(stateClient.Cliente)
            With listclient
                ...
                .ShowDialog()
                If .DialogResult = System.Windows.Forms.DialogResult.OK Then
                    idCliente = .DataGridView1.SelectedCells(0).Value
                    ...
                    Next
                    AñadeItemList()
                    ListClienComboBox.Items.Add(Convert.ToString(.DataGridView1.SelectedCells(1).Value) & " " & Convert.ToString(.DataGridView1.SelectedCells(2).Value))
