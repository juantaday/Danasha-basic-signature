...
Partial Class frmList_DeudaProveedor
    ...
    Private Sub InitializeComponent()
        ...
        Me.pagarLinkLabel.Size = New System.Drawing.Size(77, 17)
        Me.pagarLinkLabel.TabIndex = 19
        Me.pagarLinkLabel.TabStop = True
        Me.pagarLinkLabel.Text = "LinkLabel1"
        '
        'totalLabel
        '
        ...
        'FechaCompraClm
        '
        Me.FechaCompraClm.HeaderText = "Fecha y Total Factura"
    ...
    Friend WithEvents ButtonClm As DataGridViewButtonColumn
    Friend WithEvents idProveedorClm As DataGridViewTextBoxColumn
    Friend WithEvents ProveedorClm As DataGridViewTextBoxColumn
    Friend WithEvents Cant_FacturClm As DataGridViewTextBoxColumn
    Friend WithEvents Num_documentClm As DataGridViewTextBoxColumn
    Friend WithEvents FechaCompraClm As DataGridViewTextBoxColumn
    Friend WithEvents TotalClm As DataGridViewTextBoxColumn
End Class
