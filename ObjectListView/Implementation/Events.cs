...
namespace BrightIdeasSoftware
{
    ...
    public partial class ObjectListView
    {
        ...
        /// </summary>
        [Category("ObjectListView"),
        Description("This event is fired when the user double-left clicks on a cell.")]
        ...
        /// </summary>
        /// <param name="args"></param>
        protected virtual void OnCellDoubleClick(CellDoubleClickEventArgs args)
        {
        ...
        /// </summary>
        /// <param name="args"></param>
        public virtual void OnCellToolTip(ToolTipShowingEventArgs args) {
    ...
    public class CellDoubleClickEventArgs : CellEventArgs
    {
        ...
        {
            get { return this.doubleClickCount; }
            set { this.doubleClickCount = value; }
        }
