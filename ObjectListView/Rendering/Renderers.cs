...
namespace BrightIdeasSoftware {
    ...
    /// A class to render a value that contains a bitwise-OR'ed collection of values.
    /// </summary>
    public class BackGroudRenderer : BaseRenderer, IFilterAwareRenderer
    {
        ...
        private readonly Color _BackGroudColor;

        public BackGroudRenderer(Color backBroudColo)
        {
            _BackGroudColor = backBroudColo;
        }
        ...
        public override void Render(Graphics g, Rectangle r)
        {
            ...
            g.Clear(this.GetBackgroundColor());

            if (this.CellVerticalAlignment==null) this.CellVerticalAlignment = TextFormatFlags.VerticalCenter;
            if (this.cellHorizontalAlignment == null) this.cellHorizontalAlignment = TextFormatFlags.Left;

            TextFormatFlags flags = NormalTextFormatFlags | this.CellVerticalAlignment;


            if (!this.CanWrap)
                flags |= this.CellHorizontalAlignment;
            TextRenderer.DrawText(g, this.GetText(), this.Font, r, this.GetForegroundColor(), this.GetBackgroundColor(), flags);

        }

        /// <summary>
        /// aliment hotizontal
        /// es para aliner horizontalmente;
        /// </summary>
        [Browsable(true),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        public TextFormatFlags CellVerticalAlignment
        {
            get { return cellVerticalAlignment; }
            set { this.cellVerticalAlignment = value; }
        }
        private TextFormatFlags cellVerticalAlignment;
        ...
        [Browsable(true),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        public TextFormatFlags CellHorizontalAlignment
        {
            get { return cellHorizontalAlignment; }
            set { this.cellHorizontalAlignment = value; }
        }
        private TextFormatFlags cellHorizontalAlignment;
    ...
    public class DescribedTaskRenderer : BaseRenderer, IFilterAwareRenderer
    {
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public AspectGetterDelegate DescriptionAspectGetter
        {
        ...
        {
            if (this.DescriptionAspectGetter==null)
                return String.Empty;

            return this.DescriptionAspectGetter(model);
        }
        ...
        public override void Render(Graphics g, Rectangle r) {
            ...
            if (this.DescriptionAspectGetter == null)
            {
                ...
                this.DrawDescribedTask(g, r, this.GetText(), this.GetGetterDescription(this.RowObject).ToString(), this.GetImageSelector());
            }
        }
    ...
    public class ColumnButtonRenderer : BaseRenderer 
    {
        ...
        [Category("ObjectListView"),
        Description("This is image bacgrout"),
        DefaultValue(null)]
        ...
        protected override void DrawImageAndText(Graphics g, Rectangle r) {
            ...
            if (ButtonImage !=null)
            {
                ButtonRenderer.DrawButton(g, r, ButtonImage, r, false, CalculatePushButtonState());
                return;
            }
