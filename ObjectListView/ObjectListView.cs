...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public  virtual void HandleCellToolTipShowing(object sender, ToolTipShowingEventArgs e) {
...
//                    break;
        ...
        /// <summary>
        /// supuestamente debe retornar el modelo del objeto
        /// </summary>
        /// <returns>ArrayList</returns>
        public virtual IEnumerable GetObjects()
        {
            return this.Objects;
        }
